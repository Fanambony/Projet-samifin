...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="/attestation-non-paiement">Attes. non paiement</a></li>
          </ul>
        </div>
      </li>
      ...
      %>
        ...
        <li class="nav-item">
          <a class="nav-link" href="/v_historique_conge/mes-conges">
            <i class="ti-receipt menu-icon"></i>
            <span class="menu-title">Mes congés</span>
          </a>
        </li>
      <% } %>
