...
public class ServiceEmployeur {
	...
	String libelle;
	@JsonIgnore
	@OneToMany(mappedBy = "service_employeur", cascade = CascadeType.ALL)
    ...
    //CONSTRUCTORS
 	...
 	public ServiceEmployeur(){}
	public ServiceEmployeur(String id, String libelle, List<DetailUtilisateur> detailUtilisateurs){
		setId(id);
		setLibelle(libelle);
